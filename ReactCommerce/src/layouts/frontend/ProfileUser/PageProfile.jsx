...
function PageProfile() {
    ...
    useEffect(() => {
        // Fetch user data from the backend and set it to state
                            ...
                            <form className="form" onSubmit={handleSubmit} id="registrationForm">
                                ...
                                <div className="form-group">
                                    <div className="col-xs-6">
                                        <label htmlFor="last_name"><h4>Full name</h4></label>
                                        <input type="text" className="form-control" name="last_name" id="last_name" value={formData.name} onChange={handleChange} placeholder="Last name" required />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <div className="col-xs-6">
